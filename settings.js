...
SESSION_ID: process.env.SESSION_ID === undefined ? 'Manu-MD&pfVWnSLZ#YcGrm8Afz-3bWtIVNwTDbTZ9v6lul9EkafFCaG1zCVo' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
PORT: process.env.PORT === undefined ? "8000" : process.env.PORT,
SUDO: process.env.SUDO === undefined ? '919401105736' : process.env.SUDO,
